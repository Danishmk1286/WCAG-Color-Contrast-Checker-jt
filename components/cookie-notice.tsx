...
export function CookieNotice() {
  ...
  React.useEffect(() => {
    ...
    if (!cookieConsent) {
      // Only show if user hasn't made any choice yet
      setIsVisible(true)
    }
  }, [])
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-white dark:bg-gray-900 border-t-2 border-gray-200 dark:border-gray-700 shadow-2xl">
          ...
          <div className="flex items-start gap-3 flex-1">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                ...
                analytics cookies are used. By continuing to use this site, you consent to our use of cookies.{" "}
                <a href="/privacy" className="underline hover:no-underline text-blue-600 dark:text-blue-400">
